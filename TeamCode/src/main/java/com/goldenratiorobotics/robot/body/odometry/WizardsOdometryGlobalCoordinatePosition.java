 ...
 */
public class WizardsOdometryGlobalCoordinatePosition implements Runnable{
    //Odometry wheels
     ...
     */
    public WizardsOdometryGlobalCoordinatePosition(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay){
