...
public class DriveTrain {
    ...
    public void moveTheta(double speed, double theta) {
        // Left front speed
        double lf = speed * Math.cos(theta - (Math.PI / 4));
        // Right front speed
        double rf = speed * Math.sin(theta - (Math.PI / 4));
        // Left back speed
        double lb = speed * Math.sin(theta - (Math.PI / 4));
        // Right back speed
        double rb = speed * Math.cos(theta - (Math.PI / 4));
