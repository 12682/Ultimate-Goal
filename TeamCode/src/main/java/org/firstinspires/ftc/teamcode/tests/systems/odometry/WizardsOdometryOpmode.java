 ...
 */
@TeleOp(name = "Wizards Odometry OpMode")
public class WizardsOdometryOpmode extends LinearOpMode {
    //Drive motors
    ...
    public void runOpMode() throws InterruptedException {
        ...
        globalPositionUpdate = new WizardsOdometryGlobalCoordinatePosition(verticalLeft, verticalRight, horizontal, COUNTS_PER_INCH, 75);
