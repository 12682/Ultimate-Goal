...
@TeleOp(name="Test OdometryRight", group="C. Tests System")
//@Disabled
public class TestOdometryRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
           ...
           if (running){
               smartOdometry.moveRight(DistanceUnit.CM,25,.3,.6,2000);
           }
           running = false;
