...
@Autonomous(name="Red Stone Foundation Neutral Park", group="A. Autonomous")
//@Disabled
public class RedStoneFoundationNeutralPark extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if (step == 1) {
                ...
                if (skystone[2]) {
                    ...
                    while ((leftRange.readCM() < 85) && (System.currentTimeMillis() - st < timeOut)) {
                    }
                    driveTrain.reset();
                } else if (skystone[1]) {
                    //set up for Stone 1
            ...
            if (step == 2) {
                ...
                driveTrain.reset();
                driveTrain.moveForwardToPosition(.30, 80);
                driveTrain.reset();
            ...
            if (step == 3) {
                ...
                driveTrain.moveRightToPosition(.55, 2000);

                //Get closer to center of foundation
                st      = System.currentTimeMillis();
                timeOut = 4500;
                driveTrain.moveRight(.55);
                while ((rightRange.readCM() > 60) && (System.currentTimeMillis() - st < timeOut)) {
                }
                driveTrain.reset();
                sleep(100);
            ...
            if (step == 6) {
                ...
                while ((rightRange.readCM() < 100) && (System.currentTimeMillis() - st < timeOut)) {
                }
                driveTrain.reset();
                sleep(100);
                ...
                //Bump foundation closer to the corner
                driveTrain.moveRightToPosition(1,1000);

                //Park
                driveTrain.moveLeftToPosition(.45, 1550);
                driveTrain.reset();
                sleep(100);
