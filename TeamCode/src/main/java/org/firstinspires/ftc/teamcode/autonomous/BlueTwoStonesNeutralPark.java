...
@Autonomous(name="Blue 2 Stones Neutral Park", group="A. Autonomous")
//@Disabled
public class BlueTwoStonesNeutralPark extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (step == 3) {
                //Move past Skybridge
                driveTrain.moveLeftToPosition(1, 2800);
                driveTrain.reset();
            ...
            if (step == 4) {
                ...
                while ((rightRange.readCM() > 44) && (System.currentTimeMillis() - st < timeOut)) {
            ...
            if (step == 6) {
                ...
                //Move past Skybridge
                driveTrain.moveLeftToPosition(1, 4800);
                driveTrain.reset();
            ...
            if (step == 7) {
                ...
                //Park
                driveTrain.moveRightToPosition(.50, 1000);
                driveTrain.reset();
